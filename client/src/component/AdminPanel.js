...
import ModalBotton from "../container/ModalBotton";
import CrudPanel from "../crud/CrudPanel";


function AdminPanel({ allOrderConfirmed, GetAllOrdenConfirmed }) {

    const [Hover, setHover] = React.useState({ hover: false, order: null });
    
    React.useEffect(() => {

        GetAllOrdenConfirmed()
    ...
    return (
        ...
        <Grid container direction="row" justify="space-around" alignItems="center" xs={12} >
            ...
            <Grid item container direction="row" justify="center" alignItems="center" style={{ fontSize: '1.5rem', color: 'rgba(0, 0, 0, 0.54)', padding:"0.5em"}} xs={6} md={4}>
            ...
            <Grid item container direction="row" justify="center" alignItems="center" xs={12} md={2}>
               ...
               < ModalBotton props={<CrudPanel/>} icon={"Editar Productos"} style={{height: "90vh", width: "85vw" }} color={"secondary"} variant={"contained"} />
            ...
            { allOrderConfirmed.length && allOrderConfirmed.map( order =>
                                ...
                                {order.payment.type === "cash" || order.payment.type === "trans" ? 
                                    ...
                                    <Box style={{ fontSize: '1rem', color: 'rgba(0, 0, 0, 0.54)', width: "60vw", padding:"0.5em"}}>
                                        ...
                                        <Grid item container direction="row" justify="center" alignItems="center" xs={12}>
                                            ...
                                            <br/><br/>Telefono: {order.payment.phone}<br/>
                                    ...
                                    : <Box style={{ fontSize: '1rem', color: 'rgba(0, 0, 0, 0.54)', width: "60vw", padding:"0.5em"}}>
                                        ...
                                        <Grid item container direction="row" justify="center" alignItems="center" xs={12}>
                                            ...
                                            <br/><br/>{`Se abona con la tarjeta XXXX-XXXX-${order.payment.card_number} a nombre de ${order.payment.card_name}.`}
                                            <br/><br/>Telefono: {order.payment.phone}<br/>
                                        </Grid>
...
function mapStateToProps(state) {
    return {
        allOrderConfirmed: state.allOrderConfirmed
    }
}
