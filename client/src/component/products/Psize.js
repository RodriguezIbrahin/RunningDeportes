        ...
        <Typography align="center" variant="body2" style={{ fontWeight: 'bold', fontSize: '1rem'}} gutterBottom> 
            ...
            { props && props.length < 7 ?
                ...
                <Grid item container direction="row" justify="center" alignItems="center" xs ={12}>
                    ...
                    <Grid item container direction="row" justify="center" alignItems="center" xs ={10}>

                        <ToggleButtonGroup value={size} exclusive onChange={handleSize} aria-label="size" > 

                            {props && props.slice(0, 6).map( size => 
                    ...
                    <Grid item container direction="row" justify="center" alignItems="center" xs ={10}>
                        ...
                        <ToggleButtonGroup value={size} exclusive onChange={handleSize} aria-label="size" > 
                            ...
                            {props && props.slice(6, props.length).map( size => 
